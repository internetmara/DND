document.addEventListener('DOMContentLoaded', () => {
  ...
  randomNPCPic[0] = "images/NPCs/machoman.jpeg";
  ...
  fetch('http://www.dnd5eapi.co/api/monsters/').then(function (response) {
